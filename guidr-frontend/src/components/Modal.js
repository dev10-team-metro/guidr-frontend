                ...
                <div class="uk-modal-dialog">
                    ...
                    <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-middle" uk-grid>
                        ...
                        <div class="uk-padding-large">
                            ...
                            <Link className="uk-button uk-button-default homebutton" to="/collection">Begin the tour</Link>
                            <Link className="uk-button uk-button-default homebutton" to="/CollectionsPage">Go back</Link>
                        </div>
                    </div>
                </div>
            </div>
